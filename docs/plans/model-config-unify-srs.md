...
版本：v1.0
日期：2026-02-01
依据：V3.0 原型 `docs/V3.0_AITracker/project-sparkle-hub-92-c957c2e6-main-4`（`src/components/ModelSettings.tsx`、`src/lib/ai-config.ts`、`src/routes/settings.tsx`）与需求文档 `docs/requirement/*`
