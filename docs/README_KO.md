...
AITracker는 Electron, TanStack Start, React와 TypeScript로 만든 데스크톱 애플리케이션입니다. 보안 검사는 npm에 공개된 `@l3m0nc9/agent-threat-scanner` 패키지를 사용하므로 클론 후 루트 의존성만 설치하면 개발할 수 있습니다.
