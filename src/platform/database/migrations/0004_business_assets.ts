 ...
 * Keep byte-identical with 0004_business_assets.sql (LF normalized). */
export const PLATFORM_MIGRATION_0004_SQL = `-- TrustTools local storage database — migration 0004 "business assets".
