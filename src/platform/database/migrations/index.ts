/**
 * Migration definitions for the AITracker local storage database
 * (Story S-02, T-02-02).
 *
 ...
 */
export const PLATFORM_MIGRATION_0001_SQL = `-- AITracker local storage database — migration 0001 "platform".
--
...
export const PLATFORM_MIGRATION_0002_SQL = `-- AITracker local storage database — migration 0002 "low risk state".
...
export const PLATFORM_MIGRATION_0003_SQL = `-- AITracker local storage database — migration 0003 "snapshot read models".
