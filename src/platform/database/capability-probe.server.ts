 ...
 *
 * Server-only. The core decision is a pure function — `evaluateCapabilities` —
...
/** Runtime facts recorded at startup (architecture §3.2). */
...
/**
 * Baseline runtime (ADR §4.4): Electron 43.4.1 / Node 24.18.1 / SQLite 3.53.1.
