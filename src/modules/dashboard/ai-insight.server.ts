...
const DASHBOARD_INSIGHT_PROMPT = {
  ...
  version: 1,
  template: `You are TrustTools' local dashboard analyst. Analyze only the supplied aggregate JSON. Do not infer hidden activity, identifiers, paths, prompts, commands, or source content. Return JSON only with this exact shape: {"headline":"...","insights":[{"title":"...","detail":"...","severity":"info|attention|risk"}]}. Provide at most 3 concise, actionable observations. If data quality is incomplete, say so plainly.`,
} as const;
