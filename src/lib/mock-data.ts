...
export const byModel: Row[] = [
  {
    ...
    trend: "up",
    children: [
      { name: "AITracker V3.0", tokens: "1.02M", cost: "¥18.60" },
  ...
  },
  {
    ...
    trend: "up",
    children: [
      { name: "AITracker V3.0", tokens: "0.62M", cost: "¥16.40" },
  ...
  },
  {
    ...
    trend: "flat",
    children: [
      { name: "AITracker V3.0", tokens: "0.14M", cost: "¥2.20" },
...
export const memories = [
  {
    ...
    ago: "2 天前",
    source: "Claude Code",
    project: "AITracker V3.0",
  },
  {
    title: "前端自研 + 底层借鉴",
    body: "前端自研 + 底层借鉴：UI 层全部自己写，数据采集层参考 AITracker 的解析实现，价格表走 LiteLLM。不要直接依赖上游 UI 组件。",
    date: "2026-07-26",
    ago: "3 天前",
    source: "Codex",
    project: "AITracker V3.0",
