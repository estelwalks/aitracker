export const settings = {
  ...
  updateNoAsset: "새 버전 {version}이 있지만 이 플랫폼용 설치 파일이 없습니다",
  updateAsset: "설치 파일: {asset}",
  downloadUpdate: "업데이트 다운로드",
  downloading: "다운로드 중…",
  updateDownloaded: "업데이트를 다운로드했습니다. 설치할 수 있습니다",
  installUpdate: "설치 파일 열기",
  upToDate: "최신 버전입니다",
  ...
  toast: {
    ...
    autoUpdateEnabled: "자동 업데이트를 켰습니다",
    autoUpdateDisabled: "자동 업데이트를 껐습니다",
    autoUpdateSaveFailed: "자동 업데이트 설정에 실패했습니다",
