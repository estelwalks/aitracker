...
export const settings = {
  ...
  dataPath: "データパス",
  dataPathHint:
    "現在の AITracker 管理データディレクトリ。外部 AI ツールのログは含まれず、削除もされません",
  retention: "キャッシュ保持",
  retentionHint:
    "AITracker が再生成できるローカルインデックス/キャッシュのみ削除します。収集明細は元のローカルログ由来であり、AITracker が削除することはありません",
  ...
  clearCacheHint:
    "現在の AITracker データディレクトリ内のキャッシュのみ削除します。AI ツールのログ、アダプター設定、セキュリティ履歴は削除しません",
  clearCacheButton: "キャッシュを削除",
  clearCacheDialogTitle: "ローカルインデックス/キャッシュを削除しますか？",
  clearCacheDialogDesc:
    "AITracker 管理ディレクトリ内の再生成可能なインデックスとキャッシュが削除されます。外部 AI ツールのログ、アダプター設定、アプリ設定、セキュリティ履歴には影響しません。",
  clearing: "削除中...",
  ...
  resetDialogDesc:
    "AITracker のアプリ設定、バージョン更新履歴、セキュリティ検査履歴、今日の検査回数がリセットされます。ローカルインデックス/キャッシュや外部 AI ツールのログは削除されません。",
  resetting: "リセット中...",
  confirmReset: "リセット",
