export const settings = {
  ...
  updateNoAsset:
    "新しいバージョン {version} はありますが、このプラットフォーム用のインストーラーがありません",
  updateAsset: "インストーラー：{asset}",
  downloadUpdate: "更新をダウンロード",
  downloading: "ダウンロード中…",
  updateDownloaded: "更新をダウンロードしました。インストールできます",
  installUpdate: "インストーラーを開く",
  upToDate: "最新バージョンです",
  ...
  updateRestartBodyMac:
    "v{version} のダウンロードが完了しました。「今すぐ再起動して更新」を選ぶとアプリが終了し、自動でインストールして再起動します。初回起動時に macOS の確認が一度だけ表示されるので「開く」を選んでください。",
  ...
  toast: {
    ...
    autoUpdateSaveFailed: "自動更新の設定に失敗しました",
