export const security = {
  ...
  center: {
    ...
    unavailable: {
      ...
      connecting: "セキュリティスキャンデータを読み込んでいます…",
    ...
    briefing: {
      ...
      recentScan: "前回の検査 {time}",
      scannedSkills: "{count} 個の Skill を検査済み",
      nextScan: "次回 {time}",
      health: "健全度",
    ...
    task: {
      ...
      scope: "範囲",
      taskId: "タスク ID",
      unsafeSkills: "不安全な Skill · {count} 件",
      unsafeRiskDetails:
        "不安全な Skill とリスク詳細 · {skills} Skill / {findings} 件",
      needsReview: "要確認 Skill · {count} 件",
      noNeedsReview: "確認が必要な Skill はありません",
      reviewPartial: "スキャンは一部のみ完了しました",
      reviewFailed: "スキャンに失敗しました",
      reviewSkipped: "スキャンをスキップしました",
      reviewCancelled: "スキャンをキャンセルしました",
      reviewUnknown: "判定を確認する必要があります",
      riskDetails: "リスク詳細 · {count} 件",
      noFindings: "このタスクで不安全な項目はありませんでした",
      unchanged: "Skill の内容に変更がないため、前回の検査結果を使用しました",
    ...
    reportModal: {
      ...
      source: "検出元",
      sourceStatic: "静的ルール",
      sourceStaticAndModel: "静的ルール + LLM 検出",
      sourceModel: "モデル分析",
      ruleId: "ルール ID",
      cweId: "CWE ID",
      fileHash: "ファイル SHA-256",
      reasoning: "分析根拠",
      ...
      cachedTokens: "キャッシュ Token",
      tokenStatus: {
        not_applicable: "モデル未使用",
        complete: "集計完了",
        partial: "一部集計",
        unavailable: "集計不可",
      },
