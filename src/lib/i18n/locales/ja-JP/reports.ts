...
export const reports = {
  ...
  schedule: {
    title: "自動定期生成",
    desc: "日報・週報・月報を個別に有効化し、生成時刻を設定できます。",
    kinds: { daily: "日報", weekly: "週報", monthly: "月報" },
    kindHints: {
      daily: "毎日、指定した時刻に生成します",
      weekly: "毎週、指定した曜日と時刻に生成します",
      monthly: "毎月、指定した日付と時刻に生成します",
    },
    toggleKind: "{kind}の自動生成を切り替え",
    planEnabled: "{kind}の自動生成を有効にしました",
    planDisabled: "{kind}の自動生成を無効にしました",
    enabledCount: "3件中{count}件の予定を有効化",
    ...
    weekday: "曜日",
    monthDay: "毎月の日",
    monthDayHint: "該当日がない月は、その月の最終日に繰り上げて生成します",
    daily: "毎日",
    weekly: "毎週",
    monthly: "毎月",
    monthDaySuffix: "日",
    ...
    modelRequired:
      "定期レポートを有効にする前に、設定 → モデルと AI でモデルを有効にしてください。",
    editorNote:
