export const security = {
  ...
  center: {
    ...
    unavailable: {
      ...
      connecting: "Loading security scan data…",
    ...
    briefing: {
      ...
      devOnly: "Dev-only",
      startGlobalScan: "Scan now",
      allPassed: "All passed",
      needsAttention: "{count} unsafe",
      ...
      recentScan: "Recent scan {time}",
      scannedSkills: "{count} Skills scanned",
      nextScan: "Next {time}",
      health: "Health",
    ...
    vortex: {
      ...
      heading: "Global security scan",
      dimensions: "dimensions",
      cancel: "Cancel scan",
      minimize: "Minimize",
      expand: "Expand scan animation",
      scanning: "Security scan in progress",
      complete: "Scan complete",
      current: "Scanning · {name}",
      currentDimension: "Scanning · {name}",
      waiting: "Waiting for a real scan event",
      progress: "Progress: {completed}/{total}",
      risks: "{count} unsafe items found",
      noRisks: "No risks found yet",
    ...
    history: {
      ...
      scopeSingleNamed: "Single scan · {name}",
    ...
    task: {
      ...
      scope: "Scope",
      taskId: "Task ID",
      unsafeSkills: "Unsafe Skills · {count}",
      unsafeRiskDetails:
        "Unsafe Skills and risk details · {skills} Skills / {findings} findings",
      needsReview: "Skills needing review · {count}",
      noNeedsReview: "No Skills need review",
      reviewPartial: "Scan completed only partially",
      reviewFailed: "Scan failed",
      reviewSkipped: "Scan was skipped",
      reviewCancelled: "Scan was cancelled",
      reviewUnknown: "Verdict needs review",
      riskDetails: "Risk details · {count} items",
      noFindings: "No unsafe items found in this task",
      unchanged: "Skill content is unchanged; previous results were reused",
    ...
    reportModal: {
      ...
      sourceStatic: "Static rule",
      sourceStaticAndModel: "Static rule + LLM detection",
      sourceModel: "Model analysis",
      ruleId: "Rule ID",
      cweId: "CWE ID",
