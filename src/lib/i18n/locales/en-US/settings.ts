export const settings = {
  ...
  updateProxyEnable: "Enable",
  updateProxyDisable: "Disable",
  updateProxyEdit: "Edit",
  updateProxyNotEnabled: "Not enabled",
  updateProxyMissing: "No proxy address configured",
  ...
  toast: {
    ...
    updateRestartFailed: "Could not launch the updater; please try again later",
    updateInstalling:
      "Installing the update; the app reopens automatically when it finishes",
    updateInstallTimeout: "No installation detected; please try again",
    updateProxySaved: "Update proxy saved",
    updateProxySaveFailed: "Invalid proxy; could not save",
