export const settings = {
  ...
  dataPath: "Data path",
  dataPathHint:
    "AITracker-controlled data directory; it never includes or deletes external AI tool logs",
  retention: "Cache retention",
  retentionHint:
    "Only clears AITracker-regenerable local indexes/caches; usage details come from the original local logs, which AITracker never deletes",
  ...
  clearCacheHint:
    "Deletes only caches inside the current AITracker data directory; never AI tool logs, adapter configs or security history",
  clearCacheButton: "Clear cache",
  clearCacheDialogTitle: "Clear local indexes/caches?",
  clearCacheDialogDesc:
    "Regenerable indexes and caches inside the AITracker-controlled directory will be deleted. External AI tool logs, adapter configs, app preferences and security history are unaffected.",
  clearing: "Clearing…",
  ...
  resetDialogDesc:
    "AITracker app settings, version update records, security scan history and today's scan count will be reset. Local indexes/caches and external AI tool logs are not deleted.",
  resetting: "Resetting…",
  confirmReset: "Reset",
