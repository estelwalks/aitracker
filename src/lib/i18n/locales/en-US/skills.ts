export const skills = {
  ...
  agentOverview: {
    ...
    metrics: {
      usage: "Agent usage",
      usageShare: "{percent}% of all · {cost}",
      sessions: "Sessions",
      sessionsShare: "All Agents · {count} total",
      skills: "Skill coverage",
      skillsShare: "{count} Agents available",
      skillsUnavailable: "No Skill coverage data",
      security: "Security status",
      securityHint: "Safe / installed Skills",
    },
    ...
    contextCacheRead: "Cache reuse",
    contextCacheWrite: "Cache write",
